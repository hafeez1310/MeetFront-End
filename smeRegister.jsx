  ...
  return (
    ...
    <View>
      ...
      <View style={styles.action}>
       ...
       <View style={styles.action}>
            <Feather name="message-square"  color="#835da3ff" style={styles.smallIcon} />
            <TextInput placeholder=' Your area of interest and expertise'  style={styles.textInput} onChange={e=>handleInterest(e)}/>
        </View>
